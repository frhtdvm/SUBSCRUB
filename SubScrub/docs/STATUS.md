...
- Owner: `livadev`
- Project ID: `614e9950-dfbb-4feb-94fd-a20b87984188`
...
eas secret:create --scope project --name EXPO_PUBLIC_GOOGLE_CLIENT_ID_IOS --value ...
eas secret:create --scope project --name EXPO_PUBLIC_GOOGLE_CLIENT_ID_ANDROID --value ...
eas secret:create --scope project --name EXPO_PUBLIC_MICROSOFT_CLIENT_ID --value ...
...
eas submit --platform android --path /path/to/app-release.aab
```

Manual values still required at submit time:
